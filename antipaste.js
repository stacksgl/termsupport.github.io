//запрет показа сайта во фрейме меняем на свой URL
if (window.parent.frames.length > 0) { window.stop(); window.parent.location="https://kitekat.pw/";} 
...
// Запрещаем правой кнопкой орудовать.
document.oncontextmenu = noselect; 
// Запрет копирования текста в буфер.
...
<!--
document.write("<a href='https://www.ekrause.ru/' title='SEO Krause'><\/a><a href='https://www.ekrause.eu/' title='SEO Krause - search engine optimization'><\/a>")
//-->